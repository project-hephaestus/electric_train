// $Id: currdump.cpp 1182 2008-12-22 22:08:36Z dchassin $
...
currdump::currdump(MODULE *mod)
{
	if (oclass==NULL)
	{
		...
		oclass = gl_register_class(mod,"currdump",sizeof(currdump),PC_BOTTOMUP);
		if (oclass==NULL)
		...
		if (gl_publish_variable(oclass,
			...
			PT_enumeration, "mode", PADDR(mode),
				PT_KEYWORD, "rect", CDM_RECT,
				PT_KEYWORD, "polar", CDM_POLAR,
