/** $Id: fuse.cpp,v 2.2 2011/01/24 17:00:00 d3x593 Exp $
	Copyright (C) 2011 Battelle Memorial Institute
	@file fuse.cpp
	@addtogroup powerflow fuse
	@ingroup powerflow

	Implements a fuse object.

 @{
 **/

//Basic functionality stolen from switch - after switch became happy with reliability
#include <stdlib.h>
#include <stdio.h>
#include <errno.h>
#include <math.h>
...
EXPORT int init_fuse(OBJECT *obj)
{
	...
	{
		gl_error("%s (fuse:%d): %s", my->get_name(), my->get_id(), msg);
		return 0;
	}
}
